"""
Django settings for akashraja project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-o2tu7#(id5fb@q&bd!((t=7+55-_53w=v$q(k*r=pb$tli-5xo')
...
# WSGI_APPLICATION = 'akashraja.wsgi.application'
ASGI_APPLICATION = "akashraja.asgi.application"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",   # or your Docker/remote URL
        "OPTIONS": {
